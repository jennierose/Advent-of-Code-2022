class Program {
    ...
    static void Main(string[] _) {
        ...
        for (int index = 0; index < inputs.Count; index++) {
            ...
            crossCompartmentPriorityTotal += compartmentItems.Select(Program.ItemPriority).Sum();
        ...
        Console.WriteLine("Find the item type that appears in both compartments of each rucksack. What is the sum of the priorities of those item types?");
        Console.WriteLine("Answer: {0}\n", crossCompartmentPriorityTotal);

        Console.WriteLine("--- Part Two ---");
        Console.WriteLine("Find the item type that corresponds to the badges of each three-Elf group. What is the sum of the priorities of those item types?");
